# Generated by Django 3.1 on 2020-09-30 03:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('P', 'Phone'), ('TB', 'Tablet'), ('PA', 'Phone accessories'), ('C', 'Computer'), ('LP', 'Laptop'), ('CA', 'PC accessories'), ('PS', 'Printer & Scanner'), ('T', 'Television'), ('SR', 'Satellite Receiver'), ('PJ', 'Projector'), ('AD', 'Audio'), ('TA', 'TV accessories'), ('CM', 'Camera'), ('MW', 'Men Watch'), ('WW', 'Women Watch'), ('MA', 'Men accessories'), ('WA', 'Women accessories')], max_length=2)),
